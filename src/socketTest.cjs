...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        socket.on('connect', function () {
            ...
            var authData = { clientId: '116eedce-f8e7-4847-ab34-30132dd7a9ef', username: 'testuser' };
            socket.emit('authenticate', authData);
            socket.on('authenticated', function (data) {
                console.log('Autenticado: ', data);
                var clientId = '116eedce-f8e7-4847-ab34-30132dd7a9ef';
                ...
                socket.on('client data', function (clientData) {
                    ...
                    var roomData = { name: 'testroom', password: 'testpassword' };
                    socket.emit('create room', roomData);
                    socket.on('room created', function (room) {
                        console.log('Sala creada: ', room);
                        var joinData = { roomId: room.id, clientId: '116eedce-f8e7-4847-ab34-30132dd7a9ef' };
                        socket.emit('join room', joinData);
                        socket.on('joined room', function (joinedRoom) {
